...
import {
  ...
  Bug, Home, Shield, Palette, CreditCard, Settings, Calendar, Video, type LucideIcon,
} from 'lucide-react';
...
export const ROLE_PERMISSIONS: Record<UserRole, RoleConfig> = {
  ...
  org_admin: {
    ...
    navItems: [
      ...
      { href: '/my-facility', label: 'My Facility', icon: Building2, section: 'ORGANIZATION' },
      { href: '/appointments', label: 'Appointments', icon: Calendar, section: 'SERVICES' },
      { href: '/telehealth', label: 'Telehealth', icon: Video, section: 'SERVICES' },
    ],
    color: '#7C3AED',
    gradientFrom: '#6D28D9',
    gradientTo: '#7C3AED',
  ...
  nurse: {
    ...
    allowedRoutes: [
      ...
      '/lab', '/immunizations', '/anc', '/births', '/settings', '/my-facility',
      '/appointments',
    ],
    navItems: [
  ...
  payam_supervisor: {
    ...
    allowedRoutes: [
      '/dashboard/payam', '/dashboard/boma', '/patients', '/consultation', '/referrals', '/messages',
      '/lab', '/pharmacy',
    ...
    navItems: [
      { href: '/dashboard/payam', label: 'Payam Overview', icon: LayoutDashboard, section: 'CLINICAL' },
      { href: '/patients', label: 'Patients', icon: Users, section: 'CLINICAL' },
      { href: '/consultation', label: 'Consultation', icon: FileText, section: 'CLINICAL' },
      { href: '/referrals', label: 'Referrals', icon: ArrowRightLeft, section: 'CLINICAL' },
      { href: '/messages', label: 'Messages', icon: MessageSquare, section: 'CLINICAL' },
  ...
  data_entry_clerk: {
    ...
    allowedRoutes: [
      ...
      '/data-quality', '/hospitals', '/immunizations', '/anc',
